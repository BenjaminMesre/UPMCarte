...
public class LocationHome extends EntityHome<Location> {
	...
	protected List<Location> fromCursor(Cursor cursor) {
		...
		//*****************************************************************************
			loc.setBatimentID(cursor.getString(cursor
					.getColumnIndex(RedpinContract.Location.BUILDING_NAME)));
			loc.setTypeSalleID(cursor.getString(cursor
					.getColumnIndex(RedpinContract.Location.TYPEROOM_NAME)));
			
			loc.setSalleID(cursor.getString(cursor
					.getColumnIndex(RedpinContract.Location.ROOM_NAME)));
			loc.setOpeningTIME(cursor.getString(cursor
					.getColumnIndex(RedpinContract.Location.OPENING_TIME)));
			loc.setClosingTIME(cursor.getString(cursor
					.getColumnIndex(RedpinContract.Location.CLOSING_TIME)));

		//***************************************************************************
			loc.setMapXcord(cursor.getFloat(cursor
					.getColumnIndex(RedpinContract.Location.X)));
			loc.setMapYcord(cursor.getFloat(cursor
					.getColumnIndex(RedpinContract.Location.Y)));
			loc.setMapZcord(cursor.getFloat(cursor
					.getColumnIndex(RedpinContract.Location.Z)));
	...
	protected ContentValues toContentValues(Location e) {
		...
		//*****************************************************
		v.put(RedpinContract.Location.BUILDING_NAME, e.getBatimentID()); 
		v.put(RedpinContract.Location.TYPEROOM_NAME, e.getTypeSalleID());
		v.put(RedpinContract.Location.ROOM_NAME, e.getSalleID());
		
		v.put(RedpinContract.Location.OPENING_TIME, e.getOpeningTIME());
		v.put(RedpinContract.Location.CLOSING_TIME, e.getClosingTIME());
		//********************************************************
		v.put(RedpinContract.Location.X, e.getMapXcord());
		v.put(RedpinContract.Location.Y, e.getMapYcord());
		v.put(RedpinContract.Location.Z, e.getMapZcord());
		Map m = (Map) e.getMap();
		if (m != null) {
