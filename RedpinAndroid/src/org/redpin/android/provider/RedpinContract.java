...
public class RedpinContract {
	...
	public static final class Location implements RemoteBaseColumns {
		...
		public static final String TYPEROOM_NAME = "typeOfROOM"; 
		...
		public static final String Z = "mapZcord";
	...
	/**
	 * Contract for {@link org.redpin.android.core.SpinnerData}s
	 * 
	 * @author Davy Ushaka Ishimwe
	 * 
	 */
	public static final class SpinnerData implements RemoteBaseColumns {
		/**
		 * Path segment for {@link SpinnerData}s
		 */
		public static final String PATH_SEGMENT = "spinnerdatas";

		/**
		 * {@link Uri} to retrieve all {@link SpinnerData}s
		 */
		public static final Uri CONTENT_URI = Uri.parse("content://"
				+ AUTHORITY + "/" + PATH_SEGMENT);

		/**
		 * Type for {@link SpinnerData} items
		 */
		public static final String ITEM_TYPE = "vnd.android.cursor.item/vnd.redpin.spinnerdatas";

		/**
		 * Type for lists of {@link SpinnerData} items
		 */
		public static final String LIST_TYPE = "vnd.android.cursor.dir/vnd.redpin.spinnerdatas";
