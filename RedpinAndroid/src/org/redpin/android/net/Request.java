...
public class Request<D> {
	...
	public enum RequestType {
		setFingerprint, getLocation, getMapList, setMap, removeMap, getLocationList, updateLocation, removeLocation,
													 getSpinnerDataList, setSpinnerData, removeSpinnerData;
	};
	...
	private static Type spinnerdataResponseType;
	private static Type spinnerdataRequestType;
	private static Type spinnerdataListResponseType;
	...
	private void setTypes(RequestType t) {
		...
		case getSpinnerDataList:
			...
			if (spinnerdataListResponseType == null) {
				spinnerdataListResponseType = new TypeToken<Response<List<SpinnerData>>>() {
				}.getType();
			}
			responseType = spinnerdataListResponseType;
			break;
		case setSpinnerData:
			if (spinnerdataRequestType == null) {
				spinnerdataRequestType = new TypeToken<Request<SpinnerData>>() {
				}.getType();
			}
			requestType = spinnerdataRequestType;

			if (spinnerdataResponseType == null) {
				spinnerdataResponseType = new TypeToken<Response<SpinnerData>>() {
				}.getType();
			}
			responseType = spinnerdataResponseType;
			break;
