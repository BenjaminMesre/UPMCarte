...
CREATE TABLE IF NOT EXISTS 'location' (
  ...
  'typeOfRoom' varchar(90) NOT NULL,
  'roomName' varchar(90) NOT NULL, 
  'openingTime' varchar(90) NOT NULL, 
  'closingTime' varchar(90) NOT NULL,   
  'mapId' int(10) NOT NULL,
  'mapXcord' FLOAT(10, 8) NOT NULL,
  'mapYcord' FLOAT(10, 8) NOT NULL,
  'mapZcord' FLOAT(10, 8) NOT NULL,
...
CREATE TABLE IF NOT EXISTS 'spinnerdata' (
  'buildingId' INTEGER PRIMARY KEY,
  'buildingName' varchar(90) NOT NULL
  ) ;
  
 INSERT INTO spinnerdata (buildingId, buildingName) VALUES ('1','Ajoutez')