...
CREATE TABLE `location` (
  ...
  `buildingName` varchar(90) DEFAULT NULL,
  `typeOfRoom` varchar(90) DEFAULT NULL,
  `roomName` varchar(90) DEFAULT NULL,
  `openingTime` varchar(90) DEFAULT NULL,
  `closingTime` varchar(90) DEFAULT NULL,
  `mapId` int(10) unsigned DEFAULT NULL,
  `mapXcord` FLOAT(10, 8) unsigned DEFAULT NULL,
  `mapYcord` FLOAT(10, 8) unsigned DEFAULT NULL,
  `mapZcord` FLOAT(10, 8) unsigned DEFAULT NULL,
...
DROP TABLE IF EXISTS `spinnerdata`;
CREATE TABLE `spinnerdata` (
  `buildingId` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `buildingName` varchar(90) DEFAULT NULL,
   PRIMARY KEY (`numbuildingId`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
