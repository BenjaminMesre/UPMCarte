/**
 *  Filename: BaseSpinnerDataTypeAdapter.java (in org.redpin.server.standalone.json)
 ...
 *
 */
public class BaseSpinnerDataTypeAdapter implements JsonSerializer<org.redpin.base.core.SpinnerData>,
		JsonDeserializer<org.redpin.base.core.SpinnerData> {
	 ...
	 */
	@Override
	public SpinnerData deserialize(JsonElement json, Type typeOfT,
			JsonDeserializationContext context) throws JsonParseException {
		return context.deserialize(json, SpinnerData.class);
	}
