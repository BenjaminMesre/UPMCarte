...
public class HandlerFactory {
	...
	public static IHandler findHandler(RequestType type) {
		...
		switch(type) {
			...
			case getSpinnerDataList:
				return getGetSpinnerDataHandler();
			case setSpinnerData:
				return getSetSpinnerDataHandler();
	...
	//*****************************************
	private static SetSpinnerDataHandler setSpinnerDataHandler;
	
	private static SetSpinnerDataHandler getSetSpinnerDataHandler() {
		if(setSpinnerDataHandler == null) {
			setSpinnerDataHandler = new SetSpinnerDataHandler();
		}
		return setSpinnerDataHandler;
	}


	private static GetSpinnerDataListHandler getSpinnerDataListHandler;
	public static GetSpinnerDataListHandler getGetSpinnerDataHandler() {
		if(getSpinnerDataListHandler == null) {
			getSpinnerDataListHandler = new GetSpinnerDataListHandler();
		}
		
		return getSpinnerDataListHandler;
	}
	
	private static RemoveSpinnerDataHandler removeSpinnerDataHandler;
	public static RemoveSpinnerDataHandler getRemoveSpinnerDataHandler() {
		if(removeSpinnerDataHandler == null) {
			removeSpinnerDataHandler = new RemoveSpinnerDataHandler();
		}
		
		return removeSpinnerDataHandler;
	}
